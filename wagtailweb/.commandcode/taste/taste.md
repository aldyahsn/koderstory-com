...
- When using Tabler icons, only show outline variant for platforms that don't have a filled variant in Tabler — don't create custom filled versions. Confidence: 0.85
