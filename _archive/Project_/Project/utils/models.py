...
from Project.images.models import CustomImage
from Project.utils.cache import get_default_cache_control_decorator
from Project.utils.query import order_by_pk_position
